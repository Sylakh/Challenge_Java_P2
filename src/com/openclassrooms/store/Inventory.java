...
public class Inventory {
	...
	/**
	 * Remove the provided quantity of an item from the inventory Don't manage error
	 * cases. If the new quantity (existing quantity - provided quantity) is less
	 * than 0 then the inventory must contain 0;
	 * 
